...
use BufeteBundle\Form\EstudiantesType;
...
class EstudiantesController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('estudiantes_show', array('id' => $estudiante->getIdEstudiante()));
        }
    ...
    public function editAction(Request $request, Estudiantes $estudiante)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('estudiantes_edit', array('id' => $estudiante->getIdEstudiante()));
        }
    ...
    private function createDeleteForm(Estudiantes $estudiante)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('estudiantes_delete', array('id' => $estudiante->getIdEstudiante())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
