...
class Demandantes
{
    ...
    /**
     * Set residenciaDemandante
     *
     * @param string $residenciaDemandante
     *
     * @return Demandantes
     */
    public function setResidenciaDemandante($residenciaDemandante)
    {
        $this->residenciaDemandante = $residenciaDemandante;

        return $this;
    }

    /**
     * Get residenciaDemandante
     *
     * @return string
     */
    public function getResidenciaDemandante()
    {
        return $this->residenciaDemandante;
    }
    ...
    {
        $demandante = $this->nombreDemandante." ".$this->dpiDemandante;
        return $demandante;
    }
}
